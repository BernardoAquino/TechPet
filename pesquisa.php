                ...
                <li class="nav-item ml-4">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <form method="POST" action="pesquisa.php">
                            <a class="nav-link text-person mt-4" href="#"><i class="fa fa-fw fa-search"></i> <input type="text" name="pesquisar" placeholder="Procurar"></a>

                            </form>
                        </li> 

                        <li class="nav-item ml-4">
                            <button class="btn nav-link text-person mt-4" onclick="document.getElementById('id01').style.display='block'"><i class="fa fa-user-circle-o"></i> Login</button>
                        </li> 
